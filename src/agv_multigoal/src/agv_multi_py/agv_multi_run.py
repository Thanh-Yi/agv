...
goals = [
    ...
    {'x': 4.75, 'y': 0.0, 'z': math.sqrt(2)/2, 'w': math.sqrt(2)/2},
    {'x': 4.75, 'y': 1.25, 'z': 1.0, 'w': 0.0},
    {'x': 2.5, 'y': 1.25, 'z': 1.0, 'w': 0.0},
    {'x': 0.0, 'y': 1.25, 'z': math.sqrt(2)/2, 'w': math.sqrt(2)/2},
    {'x': 0.0, 'y': 2.75, 'z': 0, 'w': 1.0},
    {'x': 2.5, 'y': 2.75, 'z': 0, 'w': 1.0},
    {'x': 4.75, 'y': 2.75, 'z': 0, 'w': 1.0},
]
