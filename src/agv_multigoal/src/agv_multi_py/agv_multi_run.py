...
goals = [
    ...
    {'x': 4.8, 'y': 0.0, 'z': math.sqrt(2)/2, 'w': math.sqrt(2)/2},
    {'x': 4.8, 'y': 1.4, 'z': 1.0, 'w': 0.0},
    {'x': 2.5, 'y': 1.4, 'z': 1.0, 'w': 0.0},
    {'x': 0.0, 'y': 1.4, 'z': math.sqrt(2)/2, 'w': math.sqrt(2)/2},
    {'x': 0.0, 'y': 2.9, 'z': 0, 'w': 1.0},
    {'x': 2.5, 'y': 2.9, 'z': 0, 'w': 1.0},
    {'x': 4.8, 'y': 2.9, 'z': 0, 'w': 1.0},
]
